...
export default function ProductsPage() {
  const products = sampleWines.filter(wine => wine.tags?.includes('engraving'));

  return (
    <div className="container py-12 bg-white text-black">
      <div className="text-left mb-4">
        <h1 className="font-headline text-xl font-bold uppercase tracking-wider">Khắc Tên Lên Chai</h1>
      </div>
