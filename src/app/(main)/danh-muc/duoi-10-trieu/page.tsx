...
export default function ProductsPage() {
  const products = sampleWines.filter(wine => wine.price < 10000000);
    ...
    <div className="bg-white text-black">
      ...
      <div className="container py-12">
        <div className="text-left mb-4">
          <h1 className="font-headline text-xl font-bold uppercase tracking-wider">Whisky Dưới 10 Triệu</h1>
        </div>
