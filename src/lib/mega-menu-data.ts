export const wineMegaMenuData = {
    ...
    theoQuocGia: [
        ...
        { label: "Vang Chile", slug: "vang-chi-le", category_id: "chi-le" },
    ...
    theoVung: [
        { label: "Bordeaux", slug: "bordeaux", category_id: "bordeaux" },
        { label: "Burgundy", slug: "burgundy", category_id: "burgundy" },
        { label: "Tuscany", slug: "tuscany", category_id: "tuscany" },
        { label: "Napa Valley", slug: "napa-valley", category_id: "napa-valley"},
        { label: "Barossa Valley", slug: "barossa-valley", category_id: "barossa-valley" },
        { label: "Colchagua Valley", slug: "colchagua-valley", category_id: "colchagua-valley" },
        { label: "Puglia", slug: "puglia", category_id: "puglia" },
        { label: "Rioja", slug: "rioja", category_id: "rioja" },
        { label: "Mendoza", slug: "mendoza", category_id: "mendoza" },
        { label: "Marlborough", slug: "marlborough", category_id: "marlborough" },
    ],
    theoGiongNho: [
        { label: "Cabernet Sauvignon", slug: "cabernet-sauvignon", category_id: "cabernet-sauvignon" },
        { label: "Carmenere", slug: "carmenere", category_id: "carmenere" },
        { label: "Chardonnay", slug: "chardonnay", category_id: "chardonnay" },
        { label: "Garnacha", slug: "garnacha", category_id: "garnacha" },
        { label: "Malbec", slug: "malbec", category_id: "malbec" },
        ...
        { label: "Pinot Noir", slug: "pinot-noir", category_id: "pinot-noir" },
        ...
        { label: "Shiraz - Syrah", slug: "shiraz", category_id: "shiraz" },
...
export const spiritsMegaMenuData = {
    theoLoai: [
        { label: 'Rượu Whisky', slug: 'whisky', category_id: 'whisky' },
        { label: 'Rượu Cognac', slug: 'cognac', category_id: 'cognac' },
        { label: 'Rượu Rum', slug: 'rum', category_id: 'rum' },
        { label: 'Rượu Gin', slug: 'gin', category_id: 'gin' },
        { label: 'Rượu Vermouth', slug: 'vermouth', category_id: 'vermouth' },
        { label: 'Rượu Whisky Single Malt', slug: 'whisky-single-malt', category_id: 'whisky-single-malt' },
    ],
    thuongHieu: [
        { label: "Macallan", slug: 'macallan', category_id: 'macallan' },
        { label: "Chivas", slug: 'chivas', category_id: 'chivas' },
        { label: "Johnnie Walker", slug: 'johnnie-walker', category_id: 'johnnie-walker' },
        { label: "Ballantine's", slug: 'ballantines', category_id: 'ballantines' },
...
export const glasswareMegaMenuData = {
    ...
    lyWhisky: [
        ...
        { label: "Ly Whisky", slug: "ly-whisky", category_id: "ly-whisky" },
    ],
    khac: [
