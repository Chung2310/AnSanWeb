  ...
  const handleExport = () => {
    ...
    const dataToExport = filteredProducts.map(product => {
      ...
      const row: { [key: string]: any } = {
        ...
        'Loại rượu': wineClassification.theoLoai.join(', '),
        'Quốc gia': wineClassification.theoQuocGia.join(', '),
        'Vùng': wineClassification.theoVung.join(', '),
        'Giống nho': wineClassification.theoGiongNho.join(', '),
