...
import { Home, Package, FileText, LogOut, Tags, Link2, Settings, User, GalleryHorizontal } from 'lucide-react';
...
const navLinks = [
  ...
  { href: '/admin/banners', label: 'Quản lý Banner', icon: GalleryHorizontal },
