  ...
  const navLinks: NavLinkData[] = useMemo(() => {
    const giftSetMegaMenuColumns: MenuColumn[] = [{
        ...
        items: giftSetMegaMenuData.quaTang.map(item => ({ 
            href: `/danh-muc/${item.slug.split('/').pop()}`, 
            label: item.label 
        }))
    }];
    ...
    const navLinksList: NavLinkData[] = [
      ...
      },
      {
          ...
          megaMenuColumns: [
              {
                  title: 'Theo loại',
                  items: wineMegaMenuData.theoLoai.map(item => ({ href: `/danh-muc/${item.slug.split('/').pop()}`, label: item.label }))
              },
              {
                  title: 'Theo quốc gia',
                  items: wineMegaMenuData.theoQuocGia.map(item => ({ href: `/danh-muc/${item.slug.split('/').pop()}`, label: item.label }))
              },
              {
                  title: 'Theo vùng',
                  items: wineMegaMenuData.theoVung.map(item => ({ href: `/danh-muc/${item.slug.split('/').pop()}`, label: item.label }))
              },
              {
                  title: 'Theo giống nho',
                  items: wineMegaMenuData.theoGiongNho.map(item => ({ href: `/danh-muc/${item.slug.split('/').pop()}`, label: item.label }))
              },
          ]
      },
      {
          ...
          megaMenuColumns: [
              {
                  ...
                  items: spiritsMegaMenuData.theoLoai.map(item => ({ href: `/danh-muc/${item.slug.split('/').pop()}`, label: item.label }))
              },
              {
                  title: 'Thương hiệu',
                  items: spiritsMegaMenuData.thuongHieu.map(item => ({ href: `/danh-muc/${item.slug.split('/').pop()}`, label: item.label }))
              },
              {
                  title: 'Quà tặng',
                  items: spiritsMegaMenuData.quaTang.map(item => ({ href: `/danh-muc/${item.slug.split('/').pop()}`, label: item.label }))
              }
          ]
      },
      {
          ...
          megaMenuColumns: [
              {
                  ...
                  items: glasswareMegaMenuData.lyPhaLeRiedel.map(item => ({ href: `/danh-muc/${item.slug.split('/').pop()}`, label: item.label }))
              },
              {
                  title: 'LY WHISKY',
                  items: glasswareMegaMenuData.lyWhisky.map(item => ({ href: `/danh-muc/${item.slug.split('/').pop()}`, label: item.label }))
              },
              {
                  title: 'KHÁC',
                  items: glasswareMegaMenuData.khac.map(item => ({ href: `/danh-muc/${item.slug.split('/').pop()}`, label: item.label }))
              }
          ]
      },
      { 
